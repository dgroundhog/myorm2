        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group row">
                        <label for="sel_app_ui" class="col-sm-2 col-form-label">前端UI</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        <label for="txt_conf_has_restful" class="col-sm-2 col-form-label">启用restful</label>
                        <div class="col-sm-10">
                            <input id="txt_conf_has_restful" type="checkbox" checked data-bootstrap-switch
                                   data-off-color="danger" data-on-color="success">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="txt_conf_has_doc" class="col-sm-2 col-form-label">启用文档</label>
                        <div class="col-sm-10">
                            <input type="checkbox" id="txt_conf_has_doc" checked data-bootstrap-switch
                                   data-off-color="danger" data-on-color="success">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="txt_conf_has_test" class="col-sm-2 col-form-label">启用测试</label>
                        <div class="col-sm-10">
                            <input type="checkbox" id="txt_conf_has_test" checked data-bootstrap-switch
                                   data-off-color="danger" data-on-color="success">
                        </div>
                    </div>
                    <input type="hidden" id="txt_conf_uuid" />
                </form>
            </div>
