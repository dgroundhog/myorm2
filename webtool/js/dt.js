...
App.dt.data.ccModel_Group = function () {
    ...
    _modelGroup.field_list[_f_role.uuid] = _f_role;
...
App.dt.data.ccModel_Admin = function () {
    ...
    var _f_avatar = self.data.ccField_Img("avatar", "头像");
    ...
    _modelAdmin.field_list[_f_avatar.uuid] = _f_avatar;
    ...
    _funUpdate1.pager_size = 0;
    _funUpdate1.field_list = {};
    _funUpdate1.field_list[_f_passwd.uuid] = deepCopy(_f_passwd);
    _funUpdate1.where = deepCopy(_pkWhere);
    ...
    var _funUpdate3 = new MyFun();
    _funUpdate3.uuid = App.su.maths.uuid.create();
    _funUpdate3.ctime = _now;
    _funUpdate3.utime = _now;
    _funUpdate3.name = "Photo";
    _funUpdate3.title = "修改头像";
    _funUpdate3.memo = "";
    _funUpdate3.type = "MODIFY";
    _funUpdate3.all_field = 0;//不存在全部更新
    _funUpdate3.group_by = "";
    _funUpdate3.group_field = "";
    _funUpdate3.order_enable = 0;
    _funUpdate3.order_by = "";
    _funUpdate3.order_dir = "";
    _funUpdate3.pager_enable = 0;
    _funUpdate3.pager_size = 0;
    _funUpdate3.field_list = {};
    _funUpdate3.field_list[_f_avatar.uuid] = deepCopy(_f_avatar);
    _funUpdate3.where = deepCopy(_pkWhere);
    _modelAdmin.fun_list[_funUpdate3.uuid] = _funUpdate3;
