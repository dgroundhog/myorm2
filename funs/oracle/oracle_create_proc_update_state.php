 ...
 * @param $model
 */
function oracle_create_proc_update_state($model)
{

    if (!_oracle_proc_header($model, "update_state")) {
        return;
    }
    ...
    echo "{$_prefix} INOUT `v_state` CHAR (1)";
    ...
    echo "\nEND;\n";
    _oracle_proc_footer($model, "update_state");
}